        ...
        <div className="
            ...
            <div className="w-full pl-4 pr-4">
                ...
                <div className="flex flex-row gap-4 mt-7">
                    <button aria-label="Sign up with Google" className="flex items-center justify-center h-[34px] w-55 border-[2px] border-primary-border rounded-lg shadow-sm  hover:bg-secondary-accent-hover transition-all duration-200 cursor-pointer">
                        <img src={googleLogo} alt="Google logo" className="h-4 w-4" />
                    </button>
                    <button aria-label="Sign up with Microsoft" className="flex items-center justify-center h-[34px] w-55 border-[2px] border-primary-border rounded-lg shadow-sm  hover:bg-secondary-accent-hover transition-all duration-200 cursor-pointer">
